...
docker stop postgres2404-dev
docker run --rm --pull=always --name=postgres2404-dev --hostname postgres2404-dev --mount type=bind,source=/linuxdata/postgres2404-dev/data/,target=/data/ --mount type=bind,source=/data/,target=/datadev  -p 15432:5432  -d -i -t ghcr.io/dbca-wa/docker-apps-dev:postgresubuntu2404_latest
